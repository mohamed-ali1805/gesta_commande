...
from .views import ProductViewSet, OrderViewSet, RegenererFichierAchatView,RegenererFichierCommandeView, refresh_products, ValiderCommandeView, index, AchatViewSet, ValiderAchatView, get_dashboard_stats, ProductZeroStockViewSet
