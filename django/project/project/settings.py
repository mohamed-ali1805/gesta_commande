...
SECRET_KEY = 'django-insecure-!u50w7)axagp((5@9x=ebrq(e(!0u*ie3ij@6mz!t$v#2lf5v('
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [],  # ou [os.path.join(BASE_DIR, 'templates')] si vous avez des templates globaux
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
